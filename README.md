...
Create a notebook with a descriptive name starting with your assigned number. The descriptive name should contain the name of the data type and the sample it's working with.

If the reader your notebook will be using is not already in CIL, please contribute it to [readers](readers)

If you would like to include any images in your demonstration please add them to [images](images). Any image files should begin with your assigned number.
